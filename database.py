...
CREATE TABLE IF NOT EXISTS bot_config(
    lara_name TEXT DEFAULT 'nome aqui',                 -- Nome da lara
    lara_key TEXT DEFAULT 'chaveaqui',                                        -- Chave pix da lara
    ...
    support_user TEXT DEFAULT '@hackinfocc',                               -- Username de atendimento
    channel_user TEXT DEFAULT '@hackinfocc',                                    -- Canal de notícias
